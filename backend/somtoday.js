...
async function fetchHomework(studentId, somtoday_key) {
  ...
  try {
    const responseAppointment = await fetch(
      `${initialUrl}/rest/v1/studiewijzeritemafspraaktoekenningen?begintNaOfOp=2026-03-02&geenDifferentiatieOfGedifferentieerdVoorLeerling=${studentId}&additional=huiswerkgemaakt`, {
        method: "GET",
        headers: {
          "Authorization": `Bearer ${somtoday_key}`,
          "Accept": "application/json",
    ...
    const responseDay = await fetch(
      `${initialUrl}/rest/v1/studiewijzeritemdagtoekenningen?begintNaOfOp=2026-03-02&geenDifferentiatieOfGedifferentieerdVoorLeerling=${studentId}&additional=huiswerkgemaakt`, {
        method: "GET",
        headers: {
          "Authorization": `Bearer ${somtoday_key}`,
          "Accept": "application/json",
    ...
    const responseWeek = await fetch(
      `${initialUrl}/rest/v1/studiewijzeritemweektoekenningen?begintNaOfOp=2026-03-02&geenDifferentiatieOfGedifferentieerdVoorLeerling=${studentId}&additional=huiswerkgemaakt`, {
        method: "GET",
        headers: {
          "Authorization": `Bearer ${somtoday_key}`,
          "Accept": "application/json",
